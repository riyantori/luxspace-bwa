...
import showcaseBack from "../../assets/img/showcase-1.back.jpg";
import showcaseFront from "../../assets/img/showcase-1.front.jpg";
import showcaseRear from "../../assets/img/showcase-1.rear.jpg";
import showcaseSide from "../../assets/img/showcase-1.side.jpg";
import showcaseTop from "../../assets/img/showcase-1.top.jpg";
      ...
      <div class="flex flex-wrap my-4 md:my-12">
        ...
        <div class="flex-1">
          <div class="slider">
            <div class="thumbnail">
              <div class="px-2">
                <div class="item selected" data-img={showcaseFront}>
                  <img
                    src={showcaseFront}
                    alt="front"
              ...
              <div class="px-2">
                <div class="item" data-img={showcaseBack}>
                  <img
                    src={showcaseBack}
                    alt="back"
                    class="object-cover w-full h-full rounded-lg"
              ...
              <div class="px-2">
                <div class="item" data-img={showcaseRear}>
                  <img
                    src={showcaseRear}
                    alt="rear"
                    class="object-cover w-full h-full rounded-lg"
              ...
              <div class="px-2">
                <div class="item" data-img={showcaseSide}>
                  <img
                    src={showcaseSide}
                    alt="side"
                    class="object-cover w-full h-full rounded-lg"
              ...
              <div class="px-2">
                <div class="item" data-img={showcaseTop}>
                  <img
                    src={showcaseTop}
                    alt="top"
                    class="object-cover w-full h-full rounded-lg"
