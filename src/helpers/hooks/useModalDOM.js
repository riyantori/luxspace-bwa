...
import { addClass } from "../formating/classNameModifier";
...
export default function useModalDOM() {
  useLayoutEffect(() => {
    const openModal = (element) => {
      ...
      addClass(
        modalWrapper,
        "fixed inset-0 z-40 flex items-center justify-center w-100 h-screen"
      );
    ...
    const modalWrapperClassName = "fixed insert-0 bg-black opacity-75";
